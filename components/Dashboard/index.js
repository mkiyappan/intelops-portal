...
const Dashboard = () => {
  const [agentListCount, setAgentListCount] = useState(0);
  ...
  var data = [{
    label: 'Nokia',
    values: [{ x: 'Nokia', y: 10 }, { x: 'Micro', y: 4 }, { x: 'IBM', y: 3 }]
  }];
  ...
  const getAgentBucket = () => {
    getAgentListData().then((data) => {
      setAgentListCount(data.length);
    });
    getExperimentsListData().then((data) => {
    ...
    <div className="w-full p-6 mx-auto">
                ...
                <div className="flex-auto p-4">
                  <div className="flex flex-wrap -mx-3">
                    <div className="flex-none w-2/3 max-w-full px-3">
                      <div>
                        <p className="mb-0 font-sans text-sm font-semibold leading-normal dark:opacity-60">Total Agents</p>
              ...
              <div className="relative flex flex-col min-w-0 break-words bg-white dark:bg-gray-950 shadow-soft-xl dark:shadow-soft-dark-xl rounded-2xl bg-clip-border">
                <div className="flex-auto p-4">
                  <div className="flex flex-wrap -mx-3">
                    <div className="flex-none w-2/3 max-w-full px-3">
                      <div>
                        <p className="mb-0 font-sans text-sm font-semibold leading-normal dark:opacity-60">Total Experiments</p>
                        <h5 className="mb-0 font-bold dark:text-white">
                          {expCount}
              ...
              <div className="relative flex flex-col min-w-0 mb-6 break-words bg-white dark:bg-gray-950 shadow-soft-xl dark:shadow-soft-dark-xl rounded-2xl bg-clip-border">
                <div className="flex-auto p-4">
                  <div className="flex flex-wrap -mx-3">
                    <div className="flex-none w-2/3 max-w-full px-3">
                      <div>
                        <p className="mb-0 font-sans text-sm font-semibold leading-normal dark:opacity-60">Todays Money</p>
                        <h5 className="mb-0 font-bold dark:text-white">
                          $53,000
                          <span className="text-sm leading-normal font-weight-bolder text-lime-500">+55%</span>
                        </h5>
              ...
              <div className="relative flex flex-col min-w-0 break-words bg-white dark:bg-gray-950 shadow-soft-xl dark:shadow-soft-dark-xl rounded-2xl bg-clip-border">
                <div className="flex-auto p-4">
                  <div className="flex flex-wrap -mx-3">
                    <div className="flex-none w-2/3 max-w-full px-3">
                      <div>
                        <p className="mb-0 font-sans text-sm font-semibold leading-normal dark:opacity-60">Todays Users</p>
                        <h5 className="mb-0 font-bold dark:text-white">
                          2,300
                          <span className="text-sm leading-normal font-weight-bolder text-lime-500">+3%</span>
                        </h5>
              ...
              <div className="relative flex flex-col min-w-0 mb-6 break-words bg-white dark:bg-gray-950 shadow-soft-xl dark:shadow-soft-dark-xl rounded-2xl bg-clip-border">
                <div className="flex-auto p-4">
                  <div className="flex flex-wrap -mx-3">
                    <div className="flex-none w-2/3 max-w-full px-3">
                      <div>
                        <p className="mb-0 font-sans text-sm font-semibold leading-normal dark:opacity-60">New Clients</p>
                        <h5 className="mb-0 font-bold dark:text-white">
                          +3,462
                    ...
                    <tbody>
                      <tr>
                        <td className="p-2 align-middle bg-transparent border-b w-3/10 whitespace-nowrap dark:border-white/40">
                          <div className="flex items-center px-2 py-1">
                            <div>
                              <Image src="/assets/img/icons/flags/US.png" width={20} height={20} alt="Country flag" />
                            </div>
                            <div className="ml-6">
                      ...
                      <tr>
                        <td className="p-2 align-middle bg-transparent border-b w-3/10 whitespace-nowrap dark:border-white/40">
                          <div className="flex items-center px-2 py-1">
                            <div>
                              <Image src="/assets/img/icons/flags/DE.png" width={20} height={20} alt="Country flag" />
                            </div>
                            <div className="ml-6">
                              <p className="mb-0 text-xs font-semibold leading-tight dark:opacity-60">Country:</p>
                      ...
                      <tr>
                        <td className="p-2 align-middle bg-transparent border-b w-3/10 whitespace-nowrap dark:border-white/40">
                          <div className="flex items-center px-2 py-1">
                            <div>
                              <Image src="/assets/img/icons/flags/GB.png" width={20} height={20} alt="Country flag" />
                            </div>
                            <div className="ml-6">
                              <p className="mb-0 text-xs font-semibold leading-tight dark:opacity-60">Country:</p>
                        ...
                        <td className="p-2 align-middle bg-transparent border-b whitespace-nowrap dark:border-white/40">
                          <div className="text-center">
                            <p className="mb-0 text-xs font-semibold leading-tight dark:opacity-60">Value:</p>
                            <h6 className="mb-0 text-sm leading-normalmg dark:text-white">$190,700</h6>
                          </div>
                        </td>
                        <td className="p-2 text-sm leading-normal align-middle bg-transparent border-b whitespace-nowrap dark:border-white/40">
                          <div className="flex-1 text-center">
                      ...
                      <tr>
                        <td className="p-2 align-middle bg-transparent border-0 w-3/10 whitespace-nowrap">
                          <div className="flex items-center px-2 py-1">
                            <div>
                              <Image src="/assets/img/icons/flags/BR.png" width={20} height={20} alt="Country flag" />
                            </div>
                            <div className="ml-6">
                              <p className="mb-0 text-xs font-semibold leading-tight dark:opacity-60">Country:</p>
        ...
        <div className="w-full max-w-full px-3 mt-0 mb-6 lg:mb-0 lg:w-5/12 lg:flex-none">
          <div className="relative z-20 flex flex-col min-w-0 break-words bg-white border-0 border-solid dark:bg-gray-950 border-black-125 shadow-soft-xl dark:shadow-soft-dark-xl rounded-2xl bg-clip-border">
            <div className="flex-auto p-4">
              ...
              <p className="ml-2 text-sm leading-normal dark:opacity-60">(<span className="font-bold">+23%</span>) than last week</p>
                ...
                <div className="flex flex-wrap mt-0 -mx-3">
                  <div className="flex-none w-1/4 max-w-full py-4 pl-0 pr-3 mt-0">
                    <div className="flex mb-2">
                      ...
                      <p className="mt-1 mb-0 text-xs font-semibold leading-tight dark:opacity-60">Users</p>
                    </div>
                  ...
                  <div className="flex-none w-1/4 max-w-full py-4 pl-0 pr-3 mt-0">
                    <div className="flex mb-2">
                      ...
                      <p className="mt-1 mb-0 text-xs font-semibold leading-tight dark:opacity-60">Clicks</p>
                    </div>
                  ...
                  <div className="flex-none w-1/4 max-w-full py-4 pl-0 pr-3 mt-0">
                    <div className="flex mb-2">
                      ...
                      <p className="mt-1 mb-0 text-xs font-semibold leading-tight dark:opacity-60">Sales</p>
                    </div>
                  ...
                  <div className="flex-none w-1/4 max-w-full py-4 pl-0 pr-3 mt-0">
                    <div className="flex mb-2">
                      ...
                      <p className="mt-1 mb-0 text-xs font-semibold leading-tight dark:opacity-60">Items</p>
                    </div>
      ...
      <div className="flex flex-wrap -mx-3">
        <div className="w-full max-w-full px-3 flex-0">
          <div id="globe" className="absolute right-0 mt-24 lg-max:overflow-hidden top-1/10 sm:mt-4 lg:mr-24">
            <canvas width="700" height="600" className="w-3/4 -mr-48 h-3/4 lg-max:w-full lg:mt-12 lg:mr-0 lg:w-full"></canvas>
          </div>
        </div>
      </div>
