...
var buttons = container && container.querySelectorAll("[aria-controls]") || [];
var multisteps_form = container && container.querySelector("form") || [];
var forms = container && container.querySelectorAll("form div[form]") || [];
if(multisteps_form.length > 0)
multisteps_form.style.height = forms.length > 0 && forms[0].scrollHeight + "px" || '0px';
